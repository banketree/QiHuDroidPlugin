...
import com.eotu.droidplugin.BuildConfig;
...
public class PluginManager implements ServiceConnection {
    ...
    public static final String STUB_AUTHORITY_NAME = BuildConfig.APPLICATION_ID + ".droidplugin_stub";//"com.morgoo.droidplugin_stub";
